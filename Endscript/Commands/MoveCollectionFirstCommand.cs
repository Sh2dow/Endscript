...
{
    /// <summary>
    /// Command of type 'move_collection_first [filename] [manager] [collection]'.
    /// </summary>
    public class MoveCollectionFirstCommand : BaseCommand, ISingleParsable
	{
		private string _filename;
		private string _manager;
		private string _collection;

		public override eCommandType Type => eCommandType.move_collection_first;
		...
		public override void Execute(CollectionMap map)
		{
            ...
            for (int index2 = index1 - 1; index2 >= 0; index1--, index2--) manager.Switch(index1, index2);
		}
