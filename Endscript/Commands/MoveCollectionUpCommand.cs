...
{
    /// <summary>
    /// Command of type 'move_collection_up [filename] [manager] [collection]'.
    /// </summary>
    public class MoveCollectionUpCommand : BaseCommand, ISingleParsable
	{
		private string _filename;
		private string _manager;
		private string _collection;

		public override eCommandType Type => eCommandType.move_collection_up;
		...
		public override void Execute(CollectionMap map)
		{
            ...
            if (index2 < 0)
            {
				...
				throw new Exception($"Cannot move {this._collection} up as it is the up most collection in {this._filename}, {this._manager}.");
